...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		        XK_plus,   spawn,          SHCMD("sudo light -A 10 && pkill -RTMIN+2 dwmblocks")},
	{ MODKEY|ShiftMask,		        XK_minus,  spawn,          SHCMD("sudo light -U 10 && pkill -RTMIN+2 dwmblocks")},
	{ MODKEY|ShiftMask,		        XK_z,      spawn,          SHCMD("man -k .| dmenu -l 5 | awk '{print $1}' | xargs -r man -Tpdf | zathura -")},
	{ MODKEY,     		            XK_x,  	   spawn,          SHCMD("unicodes")},
	{ MODKEY|ShiftMask,     		XK_x,  	   spawn,          SHCMD("promt 'Power off?' poweroff")},
